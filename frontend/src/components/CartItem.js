...
const CartItem = () => {
    return (
        <div className="cartitem">
            ...
            <Link to={`/product/61cc6c32a561c326e086567d`} className="cartitem__name">
                <p>Product 1</p>
            </Link>

            <p class="cartitem__price">$499.99</p>
            ...
            <button class="cartitem__deletebtn"><i class="fas fa-trash"></i></button>
        </div>
    )
};
